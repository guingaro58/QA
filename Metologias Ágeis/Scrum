...
- **Inspeção:** o progresso é constantemente revisado.  
...
- Ajuda o time a **definir critérios de aceitação e Definition of Done (DoD)**.  
- Colabora com desenvolvedores e POs na **análise de requisitos e refinamentos**.  
...
### 🧱 Antes da Sprint (Planejamento e Refinamento)
- [ ] Participar das reuniões de **refinamento** das histórias de usuário.  
- [ ] Garantir que cada história tenha **critérios de aceitação claros**.  
- [ ] Identificar **riscos e dependências** de teste antecipadamente.  
- [ ] Ajudar o PO e o time a definir uma **Definition of Ready (DoR)** sólida.  
- [ ] Estimar **esforço de teste** junto com o time (quando aplicável).  

### 🚀 Durante a Sprint (Execução)
- [ ] Colaborar com devs para garantir que as histórias estejam sendo validadas continuamente.  
- [ ] Criar e executar **testes manuais e automatizados**.  
- [ ] Participar das **dailies** trazendo visibilidade sobre riscos, bugs e progresso.  
- [ ] Validar **builds e deploys parciais**, garantindo integridade do ambiente.  
- [ ] Priorizar correções de bugs críticos junto ao time.  
- [ ] Apoiar revisões técnicas de código/testes (quando aplicável).  

### 🔍 Após a Sprint (Review e Retrospectiva)
- [ ] Participar da **Sprint Review**, apresentando resultados e métricas de qualidade.  
- [ ] Compartilhar **indicadores de bugs**, taxa de sucesso, tempo de correção, etc.  
- [ ] Contribuir na **retrospectiva**, propondo melhorias no processo de testes ou comunicação.  
- [ ] Atualizar casos de teste e documentação conforme as entregas.  

---

## ⚙️ Onde o QA se Encaixa no Processo Scrum
...
## 🔄 Boas Práticas para o QA em Scrum

- [ ] Crie **checklists de DoR e DoD** específicos para o time.  
- [ ] Use ferramentas colaborativas (Jira, Trello, Azure, etc.) para manter visibilidade.  
- [ ] Automatize testes de regressão e smoke para ganho de velocidade.  
- [ ] Mantenha um repositório de **evidências organizadas** por sprint.  
- [ ] Documente **lições aprendidas** a cada retrospectiva.  
- [ ] Monitore indicadores como:
  - Tempo médio de correção de bugs (MTTR)  
  - Quantidade de defeitos pós-entrega  
  - Cobertura de testes automatizados  
  - Satisfação do time com o processo de QA  
...
📌 **Contribua!**  
Se quiser adicionar outros frameworks ágeis (Kanban, XP, SAFe etc.), abra um `Pull Request` com novas seções ou exemplos práticos de atuação do QA.
